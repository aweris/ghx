...
type Context struct {
	...
	Steps    map[string]*model.StepResult // Steps context to access the outputs of previous steps
...
// NewContextFromEnv creates a new context from the environment variables
